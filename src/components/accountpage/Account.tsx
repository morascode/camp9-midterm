    ...
    <div>
      ...
      <div className="flex gap-1 p-2 px-4 items-center">
        <svg
          ...
          strokeWidth="1.5"
          stroke=""
          className="w-10 h-10 fill-white-dimmed"
        >
          <path
            strokeLinecap="round"
      ...
      <div className="text-white-dimmed flex flex-col p-8 gap-11 text-lg">
        <a className="flex justify-between" href="">
          ...
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            className="w-6 h-6 stroke-white-dimmed"
          >
            <path
      ...
      <div className="flex gap-1 p-2 px-4 items-center">
        <svg
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className="w-10 h-10 stroke-white-dimmed"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        <h2 className="text-white text-xl">Customisation</h2>
      </div>
      <hr className="bg-white-dimmed ml-[5%] mr-[5%]" />
      <div className="text-white-dimmed flex flex-col p-8 gap-11 text-lg">
        <a className="flex justify-between" href="">
